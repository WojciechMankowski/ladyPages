    ...
    <div class="container about-grid">
      <div class="about-visual">
        <div class="avatar-frame">
          <img :src="avatar" alt="Wojciech Mańkowski" class="avatar-img">
      ...
      <div class="about-content">
        <span class="section-tag">Kto za tym stoi</span>
        <h2 class="section-title">Wojciech Mańkowski</h2>
        <p class="about-lead">Tłumaczę technologię na język biurowy. Pomagam ujarzmić narzędzia, których się boisz.</p>
        <p class="about-text">
          Nazywam się Wojciech Mańkowski. Na co dzień zajmuję się automatyzacją procesów biznesowych i projektowaniem architektury low-code. Od lat obserwuję, jak pracownicy biurowi marnują cenne godziny na powtarzalne, nudne czynności tylko dlatego, że nikt nie pokazał im, jak prosto można je zautomatyzować.
        </p>
        <p class="about-text">
